...
public class CollisionUtils {
     ...
     * @return
     */
    public synchronized boolean isCollision(Actor actor1, Actor actor2, float depth) {
        ...
        // 获取 演员1 缩放后的包围矩阵
        if (actor1 instanceof BirdActor) {
            rect1.setSize(
                    (float) (actor1.getWidth() * actor1.getScaleX() * 0.8),
                    (float) (actor1.getHeight() * actor1.getScaleY() * 0.9)
            );
            rect1.setPosition(
            ...
            rect1.setSize(
                    (float) (actor1.getWidth() * actor1.getScaleX() * 0.95),
                    (float) (actor1.getHeight() * actor1.getScaleY() * 0.95)
            );
            rect1.setPosition(
                    actor1.getX() - (actor1.getOriginX() * actor1.getScaleX() - actor1.getOriginX()),
                    actor1.getY() - (actor1.getOriginY() * actor1.getScaleY() - actor1.getOriginY())
        ...
        // 获取 演员2 缩放后的包围矩阵
        if (actor2 instanceof BarActor) {
            rect2.setSize(
                    (float) (70 * actor2.getScaleX() * 0.9),
                    (float) (actor2.getHeight() * actor2.getScaleY() * 0.95)
            );
            rect2.setPosition(
                    actor2.getX() - (actor2.getOriginX() * actor2.getScaleX() - actor2.getOriginX()) + 110,
                    actor2.getY() - (actor2.getOriginY() * actor2.getScaleY() - actor2.getOriginY())
            );
        } else {
            rect2.setSize(
                    (float) (actor2.getWidth() * actor2.getScaleX() * 0.95),
                    (float) (actor2.getHeight() * actor2.getScaleY() * 0.95)
            );
            rect2.setPosition(
