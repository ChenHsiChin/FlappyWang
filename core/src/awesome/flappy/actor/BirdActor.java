...
import awesome.flappy.actor.base.BaseAnimationActor;
...
public class BirdActor extends BaseAnimationActor {
     ...
     * 小鸟竖直方向上的重力加速度
     */
    private float gravity = Resource.Physics.GRAVITY;

    public BirdActor(FlappyWangGame mainGame) {
        super(mainGame);

        // 创建小鸟动画
        Animation animation = new Animation(
                0.1F, getMainGame().getAtlasWang().findRegions(Resource.Atlas.IMAGE_WANG_01_TO_04));
        // 动画循环播放
